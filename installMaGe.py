...
with open('setup_mage.sh', 'w') as file:
    ...
    file.write(f'export MGGENERATORDATA={install_path}/share/MaGe/generators\n')
    file.write(f'export MGGERDAGEOMETRY={install_path}/share/MaGe/gerdageometry\n')
    file.write(f'export MESHFILESPATH=$MAGEDIR/source/data/legendgeometry/stl_files\n')
    file.write(f'export MAGERESULTS=$MAGEDIR/source/data/legendgeometry\n')
